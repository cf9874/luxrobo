                ...
                >
                  <Row className={styles.project_item_img} justify={"center"} align={"middle"}>
                    ...
                    src={
                      ...
                      //   ? process.env.NEXT_PUBLIC_S3_URL + project.project_image
                      //   : imgAsset.projectImg
                      "https://download.luxrobo.com/eda-output/model_result_gi4qTbpN7k2GnyTmY2DpRa.pdf"
                    }
                    width={172}
                    height={92}
                    alt={project.title}
          ...
          <Space direction="vertical" size={0}>
            ...
            {isSelectProjectId !== null ? (
              <Space className={styles.project_detail_wrapper} direction="vertical" size={0}>
                ...
                >
                  {projectListState.find(v => v.projectID === isSelectProjectId)?.project_image !== "" ? (
                    <Document
                      file={projectListState.find(v => v.projectID === isSelectProjectId)?.project_image}
                    ...
                    children: (
                      <DeleteProjectModal
                        onApply={async (title: string) => {
                          ...
                          setSearchProjectListState(list =>
