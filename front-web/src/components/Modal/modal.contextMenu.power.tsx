...
export const PowerContextMenu = ({
  ...
  return (
    <Col
      className={styles.power_menu_container}
      style={{
        position: "absolute",
        top: position.y,
        left: position.x,
    ...
    >
      ...
      <Row className={styles.menu_row} onClick={onAddPowerNet}>
        <Col>
          <Image src={imgAsset.addBlock} width={24} height={24} alt="New block" />
        </Col>
        <Col className={styles.menu_title}>New Voltage Net</Col>
      </Row>
    </Col>
  )
}
