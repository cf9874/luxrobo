    ...
    <Col>
      ...
      <Row className={styles.block_info_wrapper}>
        <Col className={styles.img_wrapper}>
          <PartBlock
            ...
            activeColor={CATEGORY_COLOR[blockInfo?.category as keyof typeof CATEGORY_COLOR]}
          >
      ...
      <Row className={styles.button_group}>
        ...
        <Row className={styles.button_box}>
          <BasicButton className={styles.cancel_button} onClick={() => setOpenInfo(false)}>
            Cancel
          </BasicButton>
          <BasicButton className={styles.set_button} onClick={() => setOpenInfo(false)}>
            Set
          </BasicButton>
        </Row>
      </Row>
