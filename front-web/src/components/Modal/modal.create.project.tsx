...
export const CreateProjectModal = ({ onApply }: { onApply: (title: string) => Promise<void> }) => {
  ...
  return (
    ...
    >
      <Col className={modalStyles.basic_modal_container}>
        <Row className={modalStyles.modal_content_title}>Enter new project name to create</Row>
